...
<body class="dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm" style="height: auto;">
	<div class="wrapper">
		<a href="index3.html" class="brand-link" style="width: 100%; background-color: #343a40;">
		...
		<div class="content-wrapper" style="min-height: 896px; margin-left: 0px; padding-top: 20px;">
								...
								<div class="card-body box-profile">
									...
									<ul class="list-group list-group-unbordered mb-3">
										<li class="list-group-item">
											<b>종목</b><span class="float-right">과실</span>
										</li>
										<li class="list-group-item">
											<b>분류</b> <span class="float-right">왕득/특대/대/중/소</span>
										</li>
										<li class="list-group-item">
											<b>무게</b><span class="float-right">5KG/10KG/15KG</span>
										</li>
										<li class="list-group-item">
											<b>금액</b><span class="float-right">₩20,000원</span>
										</li>
										<li class="list-group-item">
											<b>택배비</b><span class="float-right">₩4000원</span>
										</li>
										<li class="list-group-item">
									...
									<a href="javascript:pageProductDetail();" class="btn btn-primary btn-block"><b>상세보기</b></a>
								</div>
							</div>
						</div>
						<div class="col-md-3">
							<div class="card card-primary card-outline">
								<div class="card-body box-profile">
									...
									<ul class="list-group list-group-unbordered mb-3">
										...
										<li class="list-group-item">
											<b>분류</b> <span class="float-right">대/중/소</span>
										</li>
										<li class="list-group-item">
											<b>무게</b><span class="float-right">5KG/10KG/15KG</span>
										</li>
									...
									<a href="#" class="btn btn-primary btn-block"><b>상세보기</b></a>
								</div>
							</div>
						</div>
						<div class="col-md-3">
						...
						<div class="col-md-3">
							<div class="card card-primary card-outline">
								<div class="card-body box-profile">
									...
									<ul class="list-group list-group-unbordered mb-3">
										<li class="list-group-item">
											<b>종목</b><span class="float-right">가공식품</span>
										</li>
										<li class="list-group-item">
											<b>분류</b> <span class="float-right">팩</span>
										</li>
										<li class="list-group-item">
											<b>무게</b><span class="float-right">5KG/10KG/15KG</span>
										</li>
							...
							<div class="card card-primary card-outline">
								<div class="card-body box-profile">
									...
									<ul class="list-group list-group-unbordered mb-3">
										...
										<li class="list-group-item">
											<b>분류</b> <span class="float-right"></span>
										</li>
										<li class="list-group-item">
											<b>무게</b><span class="float-right">5KG/10KG/15KG</span>
										</li>
						...
						<div class="col-md-3">
							<div class="card card-primary card-outline">
								<div class="card-body box-profile">
									...
									<ul class="list-group list-group-unbordered mb-3">
										<li class="list-group-item">
											<b>종목</b><span class="float-right">채소</span>
										</li>
										<li class="list-group-item">
											<b>분류</b> <span class="float-right">팩</span>
										</li>
