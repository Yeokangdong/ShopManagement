		...
		<div class="content-wrapper" style="min-height: 896px;">
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">배송 완료 내역</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">배송 완료 내역</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header border-transparent">
									<h3 class="card-title">배송 완료 내역 ( 3,010건 )</h3>
									<div class="card-tools">
										<div class="btn-group float-left" style="width: 270px; margin-right: 10px; margin-top: 2px;">
									...
									<table class="table table-bordered table-hover dataTable dtr-inline">
										...
										<tbody>
											<tr>
												...
												<td><span style="color: #3498db; font-weight: bold;">배송완료</span></td>
												<td>2024-08-12 15:00</td>
												<td>2024-08-15 18:00</td>
												<td>
